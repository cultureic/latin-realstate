# latin-realstate - Smart Contracts

This directory contains the smart contracts for latin-realstate, built with Hardhat and optimized for the Celo blockchain.
